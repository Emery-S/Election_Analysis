...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_turnout:
        ...
        county_results = (f"\n{county_name}: {county_vote_percentage:.1f}% ({county_votes:,})")
        ...
        if (county_votes > largest_turnout_amount):
            largest_turnout_county = county_name
            largest_turnout_amount = county_votes

        largest_county_turnout_summary = (
            f'\n----------------------\n'
            f'Largest County Turnout: {largest_turnout_county}\n'
            f'County Turnout: {largest_turnout_amount:,}\n'
            f'-----------------------\n')
    ...
    # add header for candidates for clarity
    print("\nCandidate Votes:\n")
